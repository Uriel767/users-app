...
const VALIDATORS = {
  ...
  username: {
    regex: /^[A-Za-z0-9_]*$/, // alfanumérico + guion bajo
  ...
  website: {
    regex: /^[A-Za-z0-9./:\-]*$/, // letras, números, punto, guion, slash, dos puntos
    isValid: (v) =>
  ...
  suite: {
    regex: /^[A-Za-z0-9\s.]*$/, // incluye punto por cosas como "Apt. 556"
  ...
  companyName: {
    regex: /^[A-Za-zÀ-ÿ0-9\s\-,]*$/, // letras, números, espacio, guion, coma
